exports.getWasmMetadata = async (wasmBytes) => {
  ...
  let metadata = {
    ...
    // state_input: '',
    // state_output: '',
    registry1: readMeta(memory, module.instance.exports.meta_registry()),
    registry2: readMeta(memory, module.instance.exports.meta_registry()),
    registry3: readMeta(memory, module.instance.exports.meta_registry()),
    registry3: readMeta(memory, module.instance.exports.meta_registry()),
  };
